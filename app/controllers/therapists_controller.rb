class TherapistsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @therapist.save
        ...
        format.json { render action: 'show', status: :created, location: @therapist }
      else
  ...
  def update
    respond_to do |format|
      if @therapist.update(therapist_params)
        ...
        format.json { render action: 'show', status: :ok, location: @therapist }
      else
  ...
  private
    ...
    def therapist_params
      params.require(:therapist).permit(:first_name, :last_name)
    end
end
